...
A2) Put your answer here in the form of (X, Y, BitDepth).  **(314, 225, 8-bit)**
...
Also save the resultant "Count Mask" image file with the name "Count_Mask_22946173.tif" and upload into the [image_files](image_files) directory. (It should show up below once it is uploaded).  **It isn't automatically showing up (at least right now) but I uploaded it!**
![](image_files/Count_Mask_22946173.tif)  

Q4) How many particles were detected?  
A4) Put your answer here.  **1370**

You will do a first-pass assessment of the segmentation output by analyzing the size of the particles using Python...  **Uploaded in main repository** **(just in case)**
